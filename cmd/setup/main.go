...
import (
	...
	"github.com/MK-Mods-OFC/Los-Templarios/pkg/inline"
	"github.com/MK-Mods-OFC/Los-Templarios/pkg/random"
	. "github.com/MK-Mods-OFC/Los-Templarios/pkg/validators"
	"gopkg.in/yaml.v2"
)
...
func prompts() {
	...
	if releaseChan == 0 {
		spSvc.Image = "ghcr.io/MK-Mods-OFC/Los-Templarios:latest"
	} else {
		spSvc.Image = "ghcr.io/MK-Mods-OFC/Los-Templarios:canary"
	}
	...
	if privacyMode == 1 {
		spSvc.Environment["SP_PRIVACY_NOTICEURL"] = "https://github.com/MK-Mods-OFC/Los-Templarios/blob/master/PRIVACY.md"
		...
		fmt.Println(promptui.Styler(promptui.FGBlue)("https://github.com/MK-Mods-OFC/Los-Templarios/blob/master/PRIVACY.md"))
