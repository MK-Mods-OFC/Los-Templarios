...
func (c *Help) Run(ctx *ken.Ctx) (err error) {
	...
	cmdHelp := "[Here](https://github.com/MK-Mods-OFC/Los-Templarios/wiki/Commands) you can find a list of all commands " +
	...
	emb := &discordgo.MessageEmbed{
		...
		Description: "If you generally need help with the usage or setup of shinpuru, take a look into the " +
			"[**Wiki**](https://github.com/MK-Mods-OFC/Los-Templarios/wiki). There you can find a lot of useful resources " +
