			...
			Options: append([]*discordgo.ApplicationCommandOption{
				...
				},
				{
					...
					Choices: []*discordgo.ApplicationCommandOptionChoice{
						...
						{"cyan", static.ColorEmbedCyan},
						{"red", static.ColorEmbedError},
						{"gray", static.ColorEmbedGray},
						{"green", static.ColorEmbedGreen},
						{"lime", static.ColorEmbedUpdated},
						{"orange", static.ColorEmbedOrange},
						{"violett", static.ColorEmbedViolett},
						{"yellow", static.ColorEmbedYellow},
					},
				},
				{
					Type:        discordgo.ApplicationCommandOptionString,
