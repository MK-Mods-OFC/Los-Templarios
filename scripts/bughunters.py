...
if __name__ == "__main__":
    issues = query_all_issues("MK-Mods-OFC", "Los-Templarios")
    issues = [i for i in issues if i.get("author") and i.get(
        "author").get("login") != "MK-Mods-OFC"]

    prs = query_all_prs("MK-Mods-OFC", "Los-Templarios")
    prs = [p for p in prs if p.get("merged") and p.get(
        "author") and p.get("author").get("login") != "MK-Mods-OFC"]
    ...
    data = "# Bug Hunters\n\n" \
           ...
           "or contributed directly to MK-Bot. ❤️\n\n" \
